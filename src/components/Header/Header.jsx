        ...
        {!isOpen ? (
          ...
          >
            ...
            <span className="w-[16px] h-[16px]">
              <img className="w-[16px] h-[16px]" src="src\assets\img\closeBlack.svg" alt="" />
            </span>
          </button>
        )}
      </div>
      ...
      >
        <ul className="flex text-start flex-col space-y-[20px] md:p-0 md:space-y-[5px] ">
          {[
            ...
            { label: "Services", action: () => handleSmoothScroll("services") },
        ...
        <div className="w-full md:hidden space-y-[10px] items-center mt-[60px] mb-[30px] md:mt-[120px] md:mb-[60px]">
          {/* Левая часть */}
